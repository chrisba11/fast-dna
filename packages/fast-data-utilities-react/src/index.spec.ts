...
import * as childrenWithRenderPropsSchema from "./__tests__/schemas/children-plugin.schema.json";
...
describe("getDataLocationsOfPlugins", () => {
    const childOptions: ChildOptionItem[] = [
        ...
        },
        {
            ...
            schema: childrenWithRenderPropsSchema,
        },
        {
            component: TextField,
    ...
    test("should return the data location of a single react child mapped to a plugin", () => {
        const data: any = {
            children: {
    ...
    test("should return the data location of a nested react child mapped to a plugin", () => {
        const data: any = {
            children: {
                id: childrenSchema.id,
                props: {
                    children: {
                        ...
                        props: {
                            children: {
                                id: childrenWithRenderPropsSchema.id,
                                props: {
                                    children: {
                                        id: childrenSchema.id,
                                        props: {},
    ...
    test("should return the data locations of multiple children mapped to a plugin", () => {
        const data: any = {
            children: {
                id: childrenWithRenderPropsSchema.id,
                props: {
    ...
    test("should return data locations of nested react child with multiple children mapped to a plugin", () => {
        const data: any = {
            children: {
                id: childrenSchema.id,
                props: {
    ...
    test("should return data locations of an array of nested react children with multiple children mapped to a plugin", () => {
        const data: any = {
            children: {
                id: childrenWithRenderPropsSchema.id,
                props: {
    ...
    test("should return data locations of an array of items mapped to a plugin", () => {
        const data: any = {
            children: {
                id: childrenWithRenderPropsSchema.id,
                props: {
...
describe("mapDataToComponent", () => {
    const childrenPluginResolverId: string =
        childrenWithRenderPropsSchema.reactProperties.children.pluginResolverId;
    const arrayPluginResolverId: string =
        childrenWithRenderPropsSchema.properties.array.pluginResolverId;
    const booleanPluginResolverId: string =
        childrenWithRenderPropsSchema.properties.boolean.pluginResolverId;
    const childOptions: ChildOptionItem[] = [
        { component: Children, schema: childrenSchema },
        { component: TextField, schema: textFieldSchema },
        { component: ChildrenWithRenderProp, schema: childrenWithRenderPropsSchema },
    ];
